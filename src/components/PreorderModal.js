...
const PreorderModal = React.forwardRef((props, ref) => {
    ...
    return (
        <Modal
            ...
            {isQuestionnaire ? questionnaireFormFields : emailFormFields}
            <Button block className="shout-button primary" onClick={() => setIsQuestionnaire(!isQuestionnaire)}>
                Switch
            </Button>
        </Modal>
    );
